...
![Correlation Between Weather Measurements](Pairs.png)
...
![Busch Stadium, St. Louis, MO](Average-Air-Density-StLouis.png)


In Seattle, Baltimore and Boston, the trough was in August and had a pronounced increase into the fall.

![T-Mobile Park, Seattle, WA](Average-Air-Density-Seattle.png)
![Camden Yards, Baltimore, MD](Average-Air-Density-Baltimore.png)
![Fenway Park, Boston, MA](Average-Air-Density-Boston.png)
...
![Coors Field, Denver, CO](Average-Air-Density-Colorado.png)
...
![Marlins Park, Miami, FL](Average-Air-Density-Miami.png)